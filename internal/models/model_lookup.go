...
// SameModelID kiểm tra hai định danh mô hình có trỏ đến cùng một mô hình chuẩn không (bỏ qua hậu tố ngày, chữ hoa/thường, sự khác biệt dấu chấm/gạch ngang).
...
// isDatedModelSuffix kiểm tra chuỗi có dạng "-20250514" không (gạch ngang + 8 chữ số).
