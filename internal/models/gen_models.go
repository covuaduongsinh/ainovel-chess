...
// gen_models.go kéo toàn bộ mô hình từ OpenRouter API, tạo baseline biên dịch models_generated.go.
...
const (
	...
	// maxModelAgeDays quyết định giữ lại mô hình cũ đến mức nào trong baseline. Vượt quá tuổi này được coi là lỗi thời (GPT-3.5,
	// GPT-4 gốc, Llama 2, Mistral 7b v.v.), loại bỏ trực tiếp để giảm kích thước nhị phân và nhiễu truy vấn.
	// Giữ nhất quán với bộ lọc thời gian chạy trong pricing.go.
	maxModelAgeDays = 730
)
