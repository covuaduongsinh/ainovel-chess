...
// Snapshot la anh chup chi doc toan bo tac pham trong thu muc output.
// Tat ca ham quy tac chi nhan Snapshot, khong truy cap truc tiep he thong tep.
type Snapshot struct {
	...
	LoadErrors []string // Loi tai khong phai NotExist, phan biet "khong co du lieu" va "loi doc"
}

// Load doc toan bo tac pham tu store, xay dung anh chup chi doc.
// Tep khong ton tai xem la "khong co du lieu" (truong giu gia tri zero); cac loi khac ghi vao LoadErrors.
...
// CompletedCount tra ve so chuong da hoan thanh (truy cap an toan).
...
// LatestCompleted tra ve so chuong lon nhat da hoan thanh; neu khong co tra ve 0.
