...
// Checkpoint ghi lại sự thật rằng một bước nào đó đã hoàn thành thành công.
// Được công cụ ghi thêm vào JSONL sau khi lưu nguyên tử, là nguồn sự thật duy nhất để khôi phục và quan sát.
