...
//	  \-----------------> writing
//
// Flow biểu thị luồng đang hoạt động, cho phép chuyển đổi trong thời gian viết,
// nhưng không cho phép nhảy bất thường rõ ràng:
//
...
// CanTransitionPhase kiểm tra Phase có được phép chuyển hay không.
// Quy tắc giữ đơn giản: cho phép chuyển đồng trạng thái, cho phép tiến lên, không cho phép lùi lại.
...
// ValidatePhaseTransition kiểm tra xem việc chuyển Phase có hợp lệ không.
...
// CanTransitionFlow kiểm tra FlowState có được phép chuyển hay không.
...
// ValidateFlowTransition kiểm tra xem việc chuyển FlowState có hợp lệ không.
