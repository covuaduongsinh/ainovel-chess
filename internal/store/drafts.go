...
// DraftStore quản lý cấu tứ chương, bản nháp và bản cuối.
...
// AppendDraft nối thêm nội dung vào bản nháp hiện có (chế độ tiếp tục viết).
...
// LoadChapterContent tải nội dung bản nháp chương và số chữ.
...
// SaveFinalChapter lưu nội dung chương cuối vào chapters/{ch}.md.
...
// LoadChapterText đọc văn bản gốc của bản cuối đã nộp.
...
// LoadChapterRange đọc các đoạn văn bản gốc của bản cuối trong phạm vi được chỉ định.
...
// ExtractDialogue trích xuất các đoạn hội thoại của nhân vật được chỉ định từ các chương đã nộp.
// maxCompletedChapter được truyền từ bên gọi để tránh phụ thuộc liên miền.
...
// ExtractStyleAnchors trích xuất các đoạn văn tiêu biểu từ các chương đã nộp làm neo phong cách.
// maxCompletedChapter được truyền từ bên gọi để tránh phụ thuộc liên miền.
