...
// Trong tình huống nhập một dòng, các ký tự xuống dòng và tab trong văn bản dán sẽ được gộp thành khoảng trắng.
...
// CleanInputLine làm sạch đầu vào thủ công một dòng và xóa khoảng trắng đầu/cuối.
